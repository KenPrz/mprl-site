<template>
    ...
    <AuthenticatedLayout>
      <template #header>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Frequently Ask Questions</h2>
      </template>
      <div class="py-12">
            ...
            <div class="w-full bg-white rounded-md p-4 shadow-md space-y-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-1 gap-4">
                ...
                <div class="flex justify-end mt-5">
                  <button type="" class="bg-green-500 px-3 py-1 text-white rounded-lg" @click="addFaq">Submit</button>
                </div>
              </div>
            </div>
          </div>
