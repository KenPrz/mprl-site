            ...
            <div class="w-full flex flex-col justify-center sm:px-10">
                ...
                <div class="flex w-full items-center justify-center py-4">
                  ...
                  <div class="flex w-full">
                    <a :href="route('google.login')" class="relative flex  item-center  justify-center w-full border p-3 border-black hover:bg-gray-100 rounded-lg space-x-2 text-xs sm:text-sm">
