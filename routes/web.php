...
Route::middleware([AdminMiddleware::class,'auth'])->prefix('admin')->group(function () {
    ...
    Route::post('/services/{id}', [ServicesAdminController::class, 'update'])->name('admin.services.update');
    ...
    Route::post('/projects/{id}', [ProjectAdminController::class, 'update'])->name('admin.projects.update');
